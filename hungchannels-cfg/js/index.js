...
link.rel = "stylesheet";
link.type = "text/css";
link.href = "./thanhdieuft-data/css/index.css";
...
.MangXaHoiFtThanhDieu:after {
  content: "";
  clear: both;
  display: table;
}
.MangXaHoiFtThanhDieu div:not(:last-child) {
  border-right: none; 
}
.MangXaHoiFtThanhDieu div:hover {
...
// USER NAME + TÍCH XANH
document.getElementById("userName").innerHTML = 'Vương Thanh Diệu <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/e/e4/Twitter_Verified_Badge.svg/512px-Twitter_Verified_Badge.svg.png" width="17" height="17" alt="Tích Xanh">';
// CHECK FPS
...
let typed = new Typed(".GioiThieu", {
  strings: ["Hi my name is VoQuangPhuc","Hey brother, I'm a Developer.", "I like website design =]]"],
  typeSpeed: 95,
  backSpeed: 75,
  loop: true
})
...
const ThanhDieu_List = [
  "https://files.catbox.moe/zurq9k.mp3", // Mây Đêm Chờ Mấy Đêm
  "https://files.catbox.moe/sly2n7.mp3", // Cho em 1 lần yêu
  "https://files.catbox.moe/e1r8fu.mp3", // 2AM
  "https://files.catbox.moe/l49x11.mp3", // Que boi
];
//Random music
...
function Youtube() {
  setTimeout(function() {
    window.open('https://www.tiktok.com/@vo_qphuc.1101', '_blank')},
  100);
}
function Facebook() {
  setTimeout(function() {
    window.open('https://www.facebook.com/VoQuangPhucc', '_blank')},
  100);
}
function Discord() {
  setTimeout(function() {
    window.open('https://zalo.me/voquangphucc', '_blank')},
  100);
}
function Instagram() {
  setTimeout(function() {
    window.open('https://t.me/yann_1101', '_blank')},
  100);
}
function HomeThanhDieu() {
  Swal.fire({
    title: '<span class="blink-title">𝙉𝙤𝙩𝙞𝙛𝙞𝙘𝙖𝙩𝙞𝙤𝙣 !</span>',
    html: '<span class="rainbow-text">=>> 𝙒𝙚𝙡𝙘𝙤𝙢𝙚 𝙃𝙪𝙣𝙣𝙞𝙚 𝘽𝙖𝙘𝙠 𝙏𝙤 𝙏𝙝𝙚 𝙃𝙤𝙢𝙚𝙋𝙖𝙜𝙚 🐬<<=</span>',
...
toastDiv.id = 'Toast';
toastDiv.textContent = 'voquangphuc.info';
